...
- Holographic Hover: Smooth transitions between "off" and "on" states using `hsl` color manipulation.
- Pure CSS: Zero dependencies. No JavaScript required for the styling.

Quick Start

1. Clone the repository:
   ```bash
   git clone [https://github.com/makhalimahoward/cyber-glow.git](https://github.com/makhalimahoward/cyber-glow.git)
